...
Nota importante: i riferimenti agli asset sono relativi a `index.html`. Il build non riscrive i path pubblici e puo' essere pubblicato anche in una sottocartella, purche' tutti i file restino nello stesso albero statico.
...
- il contenuto deve mantenere gli asset statici accanto a `index.html` o in path relativi coerenti;
...
- se il deploy usa un sottopercorso, tutti gli asset devono rimanere raggiungibili tramite riferimenti relativi da `index.html`;
